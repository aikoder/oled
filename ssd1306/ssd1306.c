/**
  ...
  * @version 
  * @date    2019
  * @brief   Support SSD1306 and SH1106 OLED.
  ******************************************************************************
  */
/* Includes ------------------------------------------------------------------*/
#include "configs.h"
...
#define SSD1306_DEV_ADDR 0x78
#define SSD1306_W_CMD 0x00
#define SSD1306_W_DAT 0x40
...
/* Private macro -------------------------------------------------------------*/
	...
	#define SH1106  //define SH1106 by default	
#endif
...
static void ssd1306_write_byte(uint8_t chData, uint8_t chCmd) 
{
	...
	if(chCmd)
	{
		HAL_I2C_Mem_Write(&hi2c2, SSD1306_DEV_ADDR, SSD1306_W_DAT, I2C_MEMADD_SIZE_8BIT, &data, 1, 100);
	}
	else
	{
		HAL_I2C_Mem_Write(&hi2c2, SSD1306_DEV_ADDR, SSD1306_W_CMD, I2C_MEMADD_SIZE_8BIT, &data, 1, 100);
	}
#endif
}   	  
